...
const helper = function () {
    ...
    return {
        init: function () {
            form = document.querySelector("#formForgot");
                ...
                fields: {
                    password: {
                        validators: {
                            ...
                            callback: {
                                message: 'Masukan password yang valid, dengan format huruf besar, huruf kecil, angka dan minimal 8 karakter',
                    ...
                    password_confirmation: {
                        validators: {
                            notEmpty: {
                                message: 'Password Konfirmasi Harus Di Isi'
                            },
                            identical: {
                                compare: function () {
