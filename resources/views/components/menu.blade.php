    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link" href="/list-viewKeranjang">
                        ...
                        <span class="menu-title">Dashboard Keranjang</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="/list-barang">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Files/File.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                {{-- <div class="menu-item">
                    <a class="menu-link" href="#" onclick="alertConfirm('', 'Apakah anda yakin akan keluar?')">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Files/File.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
